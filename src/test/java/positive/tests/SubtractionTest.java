...
public class SubtractionTest {
    ...
    public static class SubtractionTestParametrized {

        @Parameterized.Parameters(name = "{index}: {0} - {1} = {2}")
        public static Iterable<Object[]> data() {
            return Arrays.asList(new Object[][]{{"4", "3", "1.0"}, {"48", "6", "42.0"}, {"117", "39", "78.0"}, {"-14", "2", "-16.0"}});
        }
        ...
        public SubtractionTestParametrized(String firstOperand, String secondOperand, String answer) {
